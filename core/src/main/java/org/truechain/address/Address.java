...
import org.truechain.core.VersionedChecksummedBytes;
...
public class Address extends VersionedChecksummedBytes {
	...
	private static final long serialVersionUID = 978956461019431030L;
    ...
    public Address(NetworkParameters params, int version, byte[] hash160) throws WrongNetworkException {
        ...
        Utils.checkState(hash160.length == 20, "Addresses are 160-bit hashes, so you must provide 20 bytes");
